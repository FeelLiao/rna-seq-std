---
title: "RNA-Seq Standard Report written by Feel Liao"
output:
    html_document:
        toc: true
        toc_float: true
...
```{r, label="alignment_table", echo=FALSE}
...
```{r,label="quantification_table", echo=FALSE}
